...

    {
        ...
        public async Task<Response<NoContent>> DeleteAsync(int id)
        {
           var deletedCategory= await _categoryRepository.GetByIdAsync(id);
            ...
            {
                return Response<NoContent>.Fail("Böyle bir kategori yok", 404);
            }
        ...
        {
            var categoryList = await _categoryRepository.GetAllCategoriesAsync(false);
        ...
        public async Task<Response<NoContent>> UpdateAsync(CategoryUpdateDto categoryUpdateDto)
        {
            ...
            return Response<NoContent>.Fail("böyle bir kategori bulunmuyor", 404);
        }
    }
}
